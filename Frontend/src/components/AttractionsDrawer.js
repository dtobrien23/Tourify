...
export default function AttractionsDrawer() {
  const { isAttractionsDrawerOpen, setIsAttractionsDrawerOpen } =
    useContext(MapContext);
  return (
    <Drawer
      onClose={() => {
        setIsAttractionsDrawerOpen(false);
      }}
      isOpen={isAttractionsDrawerOpen}
      placement="left"
      size="md"
    >
      <DrawerContent
