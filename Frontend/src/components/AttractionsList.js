...
import { Box, Flex, Heading, Text, Alert, AlertIcon, AlertTitle, AlertDescription } from "@chakra-ui/react";
...
const attractions = [
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/5/5c/Brooklyn_Bridge_September_2022_008.jpg"
  },
  {
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/6/6b/NYC_-_Guggenheim_Museum.jpg"
  },
  {
    name: "Central Park",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/1/13/Central_Park_-_The_Pond_%2848377220157%29.jpg"
  },
  {
    name: "Times Square",
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/5/56/AHigh_Line_Park%2C_Section_1a.jpg"
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/d/db/GE_Building_by_David_Shankbone.JPG"
  },
  {
    name: "Broadway",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/5/56/Broadway_Theaters_45th_Street_Night.jpg"
  },
  {
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/0/06/Spirit_of_America_-_Staten_Island_Ferry.jpg"
  },
  {
    name: "The Vessel",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/f/f6/Hudson_Yards_Plaza_March_2019_53.jpg"
  },
  {
    name: "Ellis Island",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/c/c3/Aerial_view_of_Ellis_Island%2C_Jersey_City%2C_New_Jersey_LCCN2011635626_-_cropped_balance.jpg"
  },
  {
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/8/8c/One_World_Trade_Center_Tower.jpg"
  },
  {
  ...
  },
  {
    ...
    image: "https://untappedcities.com/wp-content/uploads/2020/08/featured-top-of-the-tock-observation-deck-rockefeller-center-MAnhattan-NYC1.jpg"
  },
  {
    ...
    image: "https://media.cntraveler.com/photos/5a773f26ee3bb7795af31941/16:9/w_2240,c_limit/Frick_Michael-Bodycomb_2018_14_West_Gallery_B_2010_FULL.jpg"
  },
  {
    name: "Battery Park",
    address: "New York, NY 10004, United States",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/6/62/Battery_Park.JPG"
  },
  {
    name: "Chinatown",
    address: "New York, NY, United States",
    ...
    image: "https://www.google.com/url?sa=i&url=http%3A%2F%2Ft3.gstatic.com%2Flicensed-image%3Fq%3Dtbn%3AANd9GcQuBCMWcw_hsMqaDVWb3c-Mqg3uT7LfJXyb7HSK_U9nOac7v2VKHrmqrOJMAj9BvMMf&psig=AOvVaw1hgexvewCmBzUQCF1I9-IK&ust=1686920820682000&source=images&cd=vfe&ved=0CAwQjhxqFwoTCKCrgPSrxf8CFQAAAAAdAAAAABAD"
  }
];

function Attraction({ name, address, openingHours, website, image }) {
  return (
    <Flex mb={8} border="1px" borderRadius="20px" borderColor="orangered" bg="white" justify="center" align="center" w="80%" >
        <Box flex="1" >
          <img src={image} alt={name} border="1px" borderRadius="20px" 
      ...
      <Alert status='success' borderRadius={20}>
            ...
            <AlertDescription>You have already visited this attraction.</AlertDescription>
        </Alert>
        <Alert status='error' borderRadius={20} mt={5}>
            <AlertIcon />
            <AlertTitle>Busy</AlertTitle>
            <AlertDescription>This attraction is currently busy.</AlertDescription>
        </Alert>
      </Flex> 
    </Flex>
  );
